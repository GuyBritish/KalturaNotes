...
const VideoPlayer = (props) => {
	return (
		<React.Fragment>
			...
			<iframe id="kaltura_player" src="https://cdnapisec.kaltura.com/p/1660902/sp/166090200/embedIframeJs/uiconf_id/44363851/partner_id/1660902?iframeembed=true&playerId=kaltura_player&entry_id=1_8ezksef0&flashvars[streamerType]=auto&amp;
			...
			&wid=1_5kpj17v6" width="500" height="569" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *"  frameborder="0" title="Kaltura Player"></iframe>
		</React.Fragment>
	);
};
