...
const VideoPlayer = (props) => {
	return (
		<React.Fragment>
			...
			<iframe
				id="kaltura_player"
				src={`https://cdnapisec.kaltura.com/p/1660902/sp/166090200/embedIframeJs/uiconf_id/44363851/partner_id/1660902?iframeembed=true&playerId=kaltura_player&entry_id=${props.vidurl}&flashvars[streamerType]=auto&amp;
